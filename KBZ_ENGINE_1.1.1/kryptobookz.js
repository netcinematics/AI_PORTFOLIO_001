...
function initPage() {
    ...
    function runDISPLAYFactory(mode, CID) {
        ...
        try {
            ...
            if (mode === 1) {// gallery - initialized on load
                clearAllDisplays();
                if (ui.GalleryDISPLAYFRAME1) {
                    ui.onGalleryView = true;
    ...
    function setCERTPAGE() {
        ...
        pageFrame.id = 'CertPageFrame';//.replace('.','-'));
        ...
        for (let i = 0; i < AI_CERTS.length; i++) {
            workbitz = AI_CERTS[i];
            if (workbitz.TTL) {
                console.log('TTL', workbitz.TTL); //DYNAMIC TEXT
            ...
            if (workbitz.IMG) {
                console.log('IMG', workbitz.IMG); //DYNAMIC IMAGE
            ...
            if (workbitz.SUB) {
                console.log('TXT', workbitz.TXT); //DYNAMIC TEXT
        ...
        var AIProjectRow1 = 0;
        AIProjectRow1 = document.createElement('article');
        AIProjectRow1.style.backgroundColor = 'black';
        AIProjectRow1.style.boxShadow = "0px 0px 20px 1px purple"
        AIProjectRow1.style.border = "1px solid steelblue"
        AIProjectRow1.style.borderRadius = "13px"
        AIProjectRow1.style.padding = "0.888em"
        AIProjectRow1.style.margin = "0.88em auto"
        AIProjectRow1.style.maxWidth = "90%"
        // AIProjectRow1.style.cursor = "pointer"
        AIProjectRow1.style.overflow = "hidden";
        AIProjectRow1.style.marginBottom = "1em";
        AIProjectRow1.style.color = 'steelblue';
        AIProjectRow1.style.borderTop = "none";    //OVERLAP        

        var txtCard1 = 0;
        txtCard1 = document.createElement('footer'); //IMG  //OTHER IMAGE TYPES HERE
        txtCard1.innerText = "PROFESSIONAL EDUCATION"; //large 600 size
        ...
        txtCard2.innerText = "CERTIFICATIONS"; //large 600 size
    ...
    <section id="AI_PROJECTS" style="display: flex;line-height:2em;color:steelblue;">
        ...
        if (AIProjectRow1) { AIProjectRow1.innerHTML = AIProjectTXT; }
        if (pageFrame && TXTFRAME) { pageFrame.insertAdjacentElement('beforeend', TXTFRAME); }
        if (pageFrame) { pageFrame.insertAdjacentElement('beforeend', AIProjectRow1); }
